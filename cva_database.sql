...
CREATE TABLE tbl_administrador (
    ...
    FOREIGN KEY (adm_codigo_consulta) REFERENCES tbl_consultas(con_codigo_consulta)
);
...
CREATE TABLE tbl_seguimiento_solicitud (
    ...
    seg_numero_seguimiento VARCHAR(10) PRIMARY KEY,
...
CREATE TABLE tbl_solicitud_visa (
    ...
    FOREIGN KEY (vis_numero_formulario) REFERENCES tbl_formulario_solicitud(for_numero_formulario)
);
